...
filename_train_validation_set = '/scratch/rgongcrnnSingleSoundEvaluator_timbre_nogru/data/trainData_timbre.pkl'
...
if __name__ == '__main__':
    file_path_model = '/scratch/rgongcrnnSingleSoundEvaluator_timbre_nogru/out/crnn_model_cw_timbre_nogru.h5'
