...
filename_train_validation_set = '/scratch/rgongcrnnSingleSoundEvaluator_timbre_gru2layers_20nodes/data/trainData_timbre.pkl'
...
def crnn_model(filter_density, pool_n_row, pool_n_col, nlen, dropout):
    ...
    model.add(GRU(20, return_sequences=True, name='gru1'))
...
if __name__ == '__main__':
    file_path_model = '/scratch/rgongcrnnSingleSoundEvaluator_timbre_gru2layers_20nodes/out/crnn_model_cw_timbre_gru2layers_20nodes.h5'
