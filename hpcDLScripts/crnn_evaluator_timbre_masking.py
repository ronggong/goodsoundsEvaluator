...
filename_train_validation_set = '/scratch/rgongcrnnSingleSoundEvaluator_timbre_masking/data/trainData_timbre.pkl'
...
if __name__ == '__main__':
    file_path_model = '/scratch/rgongcrnnSingleSoundEvaluator_timbre_masking/out/crnn_model_timbre_cw_masking.h5'
