...
filename_train_validation_set = '/scratch/rgongcrnnSingleSoundEvaluator_timbre/data/trainData_timbre.pkl'
...
if __name__ == '__main__':
    file_path_model = '/scratch/rgongcrnnSingleSoundEvaluator_timbre/out/crnn_model_cw_timbre.h5'
