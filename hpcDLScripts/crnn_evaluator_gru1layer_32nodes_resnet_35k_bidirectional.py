...
def crnn_model(filter_density, pool_n_row, pool_n_col, nlen, dropout, include_top=True):
    ...
    x = Convolution2D(int(13 * filter_density), 3, 3, border_mode='valid',
    ...
    x_res_1_left = Convolution2D(int(26 * filter_density), 3, 3, border_mode='same',
                  input_shape=reshape_dim, dim_ordering='tf',
                  init='he_uniform', W_regularizer=l2(1e-5))(x)
    ...
    x_res_1_right = Convolution2D(int(26 * filter_density), 3, 3, border_mode='same',
                                 input_shape=reshape_dim, dim_ordering='tf',
                                 init='he_uniform', W_regularizer=l2(1e-5))(x)
    ...
    x_res_2_left = Convolution2D(int(26 * filter_density), 3, 3, border_mode='same',
                                 input_shape=reshape_dim, dim_ordering='tf',
...
if __name__ == '__main__':
    ...
    # nb_epoch = 10
    # file_path_model = '/scratch/rgongcrnnSingleSoundEvaluator_'+feature_string+'_gru1layer_10nodes_dense/out/crnn_model_cw_'+feature_string+'_gru1layer_32nodes_resnet_35k_bidirectional.h5'

    file_path_model = '/scratch/rgongcrnnSingleSoundEvaluator_' + feature_string + '_gru1layer_10nodes_dense/out/'
    # file_path_model = '../models/'
    file_name_model = 'crnn_model_cw_' + feature_string + '_gru1layer_32nodes_resnet_35k_bidirectional'
