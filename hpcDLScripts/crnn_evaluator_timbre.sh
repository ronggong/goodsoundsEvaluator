...
if [ -d /scratch/rgongcrnnSingleSoundEvaluator_timbre ]; then
        rm -Rf /scratch/rgongcrnnSingleSoundEvaluator_timbre
fi

# Second, replicate the structure of the experiment's folder:
# -----------------------------------------------------------
mkdir /scratch/rgongcrnnSingleSoundEvaluator_timbre
mkdir /scratch/rgongcrnnSingleSoundEvaluator_timbre/data
mkdir /scratch/rgongcrnnSingleSoundEvaluator_timbre/error
mkdir /scratch/rgongcrnnSingleSoundEvaluator_timbre/out

# Thir, copy the experiment's data:
# ----------------------------------
cp -rp /homedtic/rgong/noteEval/data/trainData_timbre.pkl /scratch/rgongcrnnSingleSoundEvaluator_timbre/data
...
python /homedtic/rgong/noteEval/crnn_evaluator_timbre.py

# Copy data back, if any
# ----------------------
printf "rgongcrnnSingleSoundEvaluator_timbre processing done. Moving data back\n"
cp -rf /scratch/rgongcrnnSingleSoundEvaluator_timbre/out/* /homedtic/rgong/noteEval/out
