...
filename_train_validation_set = '/scratch/rgongcrnnSingleSoundEvaluator_timbre_nogru_10k/data/trainData_timbre.pkl'
...
print(X_train_validation.shape, Y_train_validation.shape)
...
def crnn_model(filter_density, pool_n_row, pool_n_col, nlen, dropout):
    ...
    # model.add(Reshape((model.output_shape[1]*model.output_shape[2],64)))
    model.add(Flatten())
...
if __name__ == '__main__':
    file_path_model = '/scratch/rgongcrnnSingleSoundEvaluator_timbre_nogru_10k/out/crnn_model_cw_timbre_nogru_10k.h5'
