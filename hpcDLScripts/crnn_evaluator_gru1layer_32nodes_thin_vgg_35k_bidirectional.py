...
if __name__ == '__main__':
    ...
    file_path_model = '/scratch/rgongcrnnSingleSoundEvaluator_'+feature_string+'_gru1layer_10nodes_dense/out/crnn_model_cw_'+feature_string+'_gru1layer_32nodes_thin_vgg_35k_bidirectional.h5'
